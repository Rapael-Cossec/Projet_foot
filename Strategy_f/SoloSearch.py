...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 16:49:11 2019
...
class SoloSearch(object):
    def __init__ (self, strategy, params, simu = None, trials =20, max_steps =1000000, max_round_step =2000):
    ...
    def begin_round (self, team1, team2, state):
        ...
        self.simu.state.states[(1,0)].position = Vector2D(30,30) # Player position
